...
void at32_msp_usart_init(void *instance)
{
    ...
    if (USART1 == usart_x)
    { /* rt-thread serial console, txd on PA9, rxd on PA10 */
    ...
    if (USART2 == usart_x)
    { /* target serial console, txd on PA2, rxd on PA3 */
...
void at32_msp_spi_init(void *instance)
{
    ...
    { /* st7789 display */
        ...
        gpio_pin_mux_config(GPIOB, GPIO_PINS_SOURCE2, GPIO_MUX_6);
    }
#endif
    /* add others */
}
...
void at32_msp_adc_init(void *instance)
{
    ...
    if (adc_x == ADC1)
    {
        ...
        /* configure adc channel as analog input. PC0 is light sensor, PC3 is target VIO */
